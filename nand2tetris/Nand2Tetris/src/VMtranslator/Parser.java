...
public class Parser {
	...
	int commandType(){
		if      (type.equals("push"    ))   return C_PUSH;
		else if (type.equals("pop"     ))   return C_POP;
		else if (type.equals("label"   ))   return C_LABEL;
		else if (type.equals("goto"    ))   return C_GOTO;
		else if (type.equals("if"      ))   return C_IF;
		else if (type.equals("function"))   return C_FUNCTION;
		else if (type.equals("return"  ))   return C_RETURN;
		else if (type.equals("call"    ))   return C_CALL;
